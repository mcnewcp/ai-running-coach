# Week 11 Training Log - Music City Half Marathon

**Dates**: March 16 - 22, 2026
**Training Phase**: Phase 2 - Build (Week 5 of 5) **[PEAK BUILD WEEK]**
**Week Goal**: ~27 miles running — highest volume week of the program
**Key Focus**: Progressive long run with race-effort finish (11 mi), highest weekly mileage
...
**Weekly Targets**:
- Total Running Mileage: ~27 miles (5-6 easy runs + progressive long run)
- Long Run: 11.0 miles (new distance PR — progressive finish)
- HSR Sessions: 2 (Monday/Thursday)
- Sauna Sessions: 4
- No hard mid-week workout — Saturday's progressive long run is the week's hard session

**Key Note**: This is the most important week of Phase 2. The progressive long run simulates race conditions — 8 easy miles followed by 3 at half marathon effort on tired legs.
...
**Morning Check-In**:
- Sleep: 6hr 41min, good quality (tornado warning interrupted night — had to wake kids and take shelter)
- Resting Heart Rate: 51 bpm (Sunday avg — new low tied with recent best)

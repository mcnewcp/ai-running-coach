# Week 7 Training Log - Music City Half Marathon

**Dates**: February 16-22, 2026
**Training Phase**: Phase 2 - Build (Week 1 of 5)
**Week Goal**: ~21 miles running
**Key Focus**: Tempo extension (25 min), first 9-mile long run
...
- Long Run: 9.0 miles (new distance PR)
- HSR Sessions: 2 (adjust if knee needs extra recovery)
- Sauna Sessions: 4 (resume after Disney week off)
- Hard Workout: Tempo run (Wednesday, 25 min)
...
**Morning Check-In**:
- Sleep: 7hr 2min, ok quality
- Resting Heart Rate: 55 bpm
- Knee Pain: Left 3/10, Right 0/10
- Energy: 7/10
- Motivation: 6/10
- Life Stress: 7/10 (travel day with kids — returning from Disney)

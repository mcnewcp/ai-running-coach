# Week 16 Training Log - Music City Half Marathon

**Dates**: April 20 - 25, 2026
**Training Phase**: Phase 4 - Taper (Week 2 of 2) — **RACE WEEK**
**Week Goal**: Arrive at the start line healthy, rested, and ready
**Key Focus**: Illness recovery, minimal volume, maintain sharpness, race logistics
...
|-----|------|---------|--------|--------|
| Monday | Apr 20 | Easy shakeout OR Rest | 2-3 mi very easy OR full rest (illness call) | |
| Tuesday | Apr 21 | Easy shakeout | 3 mi easy, Zone 2 | |
| Wednesday | Apr 22 | Short tempo sharpener | 10-15 min at threshold (reduced from 20) | |
| Thursday | Apr 23 | Rest or 2-mi shakeout | Rest preferred | |
| Friday | Apr 24 | Complete rest or 15-min shakeout | Shakeout preferred | |
| Saturday | Apr 25 | **RACE DAY — Music City Half Marathon** | 13.1 miles | |
| Sunday | Apr 26 | Recovery walk or rest | Celebrate | |

**Weekly Targets**:
- Total Running Mileage: ~8-10 miles (illness-adjusted from plan's 13)
- HSR Sessions: 0 (race week — legs fresh)
- Sauna Sessions: 2-3 (light, aid recovery)
- Primary Goal: Fully clear illness by Thursday

**Race Week Philosophy**:
- "Less is more" applies triple-strength this week
- Fitness is banked. Nothing added this week helps race performance.
- Anything done this week can HURT race performance if overdone
- Illness resolution is the #1 priority — running takes a back seat to recovery until symptoms fully clear
- Race Saturday at Music City Half — 5 days out as of Monday
...
**Morning Check-In**:
- Sleep (Sun night): 6hr 49min, ok quality
- Resting Heart Rate: **53 bpm** (Sunday avg — back to near baseline! Only +1 over 52 baseline)
- Knee Pain: Left 1/10, Right 0/10
- Energy: 6/10
- Motivation: 5/10
- Life Stress: 5/10
- **Still not feeling great — some coughing continuing**
- Overall Status: **Big positive signal: RHR dropped from 58 (Fri) to 53 (Sun) — autonomic system finally normalizing.** Illness appears to be in final resolution phase. Knees excellent (L1/R0). Subjective markers flat (energy 6, motivation 5 — same as last Thursday). Cough still present but trending down per user. Sunday's 5-miler at HR 144 / 10:40 pace confirms the aerobic engine is fine. 5 days to race. Monday priority: do not re-stress the system while the cough is still clearing.

**Planned Workout (Race Week Protocol)**: Easy shakeout 3-4 mi

**Recommended Modification**: **REST TODAY, or 2-mile max very-easy shakeout if you feel markedly better by midday.**

Decision criteria:
- If cough is dry/minor and energy rises as day progresses → 2-mile very easy shakeout (HR <140, 11:30+ pace, flat route)
- If cough is productive/chesty, or energy stays flat → full rest day

Regardless:
- NO HSR today
- NO sauna if still actively coughing (heat stress + immune load is a bad combo)
- Hydration + warm liquids + electrolytes

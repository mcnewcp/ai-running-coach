# Week 12 Training Log - Music City Half Marathon

**Dates**: March 23 - 29, 2026
**Training Phase**: Phase 3 - Peak (Week 1 of 3)
**Week Goal**: ~30 miles running — first peak phase week
**Key Focus**: HM pace run (5 mi at goal pace), long run extends to 12 miles
...
- Resting Heart Rate: 50 bpm (Sunday avg — new all-time low!)
- Knee Pain: Left 2.5/10, Right 0/10
- Energy: 8/10
- Motivation: 8/10
- Life Stress: 6/10
- Overall Status: Excellent start to Peak phase. RHR hits a new all-time low of 50 — cardiovascular fitness continuing to improve week over week. Left knee dropping from 3 post-long-run to 2.5 overnight shows good recovery. Energy and motivation both at 8. Sleep back above 7 hours. Body is well-recovered from Saturday's 11-mile progressive long run and ready for the next level.
